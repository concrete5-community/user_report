...
class UsersCreated implements ApplicationAwareInterface
{
    use ApplicationAwareTrait;

    public function view()
    {
        $view = new View('chart/users_created');
        $view->setPackageHandle('user_report');

        $results = $this->app->make(\A3020\UserReport\Statistics\UsersCreated::class)->get();
